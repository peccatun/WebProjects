    ...
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    About = table.Column<string>(maxLength: 50, nullable: false),
                    AdditionalInfo = table.Column<string>(maxLength: 500, nullable: false),
                    Image = table.Column<byte[]>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Information_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Information_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Solutions_Discussions_DiscussionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Information_ApplicationUserId",
                table: "Information",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Information_CategoryId",
                table: "Information",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Solutions_DiscussionId",
                table: "Solutions",
                column: "DiscussionId");
        }
